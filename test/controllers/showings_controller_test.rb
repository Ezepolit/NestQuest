...
class ShowingsControllerTest < ActionController::TestCase
  ...
  test "should create showing" do
    assert_difference('Showing.count') do
      post :create, showing: { date: @showing.date, details: @showing.details, duration: @showing.duration, location: @showing.location, time: @showing.time }
    end
  ...
  test "should update showing" do
    patch :update, id: @showing, showing: { date: @showing.date, details: @showing.details, duration: @showing.duration, location: @showing.location, time: @showing.time }
    assert_redirected_to showing_path(assigns(:showing))
  end
